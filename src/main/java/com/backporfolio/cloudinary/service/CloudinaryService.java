...
public class CloudinaryService {
	...
	public CloudinaryService() {
		valuesMap.put("cloud_name", "dfn4grpcw");
		valuesMap.put("api_key", "479219953516779");
		valuesMap.put("api_secret", "I4d96gJ_tizqKiulNRv4t-CZ_ak");
	...
	private File convert(MultipartFile multiparFile) throws IOException {
		...
		fo.write(multiparFile.getBytes());
		fo.close();
